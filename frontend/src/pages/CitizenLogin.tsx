      ...
      <div className="w-full max-w-md">
        ...
        <GlassCard className="border border-white/10 shadow-2xl p-8 relative">
          ...
          <div className="mb-6 space-y-2">
            <h2 className="text-xl font-bold text-slate-200">Welcome, Citizen</h2>
            <p className="text-xs text-slate-400 leading-relaxed">
              Login instantly to submit public complaints, track progress via the multilinguistic AI model, and monitor constituency projects.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-4 space-y-2">
              <div className="flex items-center gap-2 text-xs font-bold text-slate-300">
                ...
                <span>Secure Demo Account Loaded</span>
              </div>
              <p className="text-[11px] text-slate-500">
                Email: <code className="text-brand-400 select-all">citizen.demo@jansetu.in</code>
              </p>
            </div>
